...
const features = [
  ...
  },
  {
    ...
    link: { href: '/uploads/sample-vet-report.pdf', label: 'View Sample Report' },
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    id: 'multi-pet-profiles',
    title: 'Multi-Pet Profiles',
    description: 'Manage separate profiles for each pet with individualized tracking, insights, and health records.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
