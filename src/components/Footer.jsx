...
function Footer() {
  const footerLinks = [
    { name: 'Contact Us', href: 'mailto:support@pawrelief.com', external: true },
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <img src="/uploads/daylight.svg" alt="Paw Relief Logo" className="w-10 h-10" />
              <span className="text-2xl font-bold">Paw Relief</span>
            </div>
